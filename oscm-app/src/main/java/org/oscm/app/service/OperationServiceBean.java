...
public class OperationServiceBean {
    ...
    List<OperationParameter> toBES(
            List<org.oscm.app.data.OperationParameter> operationParameters) {
        List<OperationParameter> result = new ArrayList<>();
        if (operationParameters != null) {
            for (org.oscm.app.data.OperationParameter op : operationParameters) {
    ...
    public List<OperationParameter> getParameterValues(String userId,
        ...
        try {
            ...
            List<org.oscm.app.data.OperationParameter> operationParameters = controller
