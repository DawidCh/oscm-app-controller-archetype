[![Build Status](https://travis-ci.org/servicecatalog/oscm-app-controller-archetype.svg?branch=master)](https://travis-ci.org/servicecatalog/oscm-app-controller-archetype)
